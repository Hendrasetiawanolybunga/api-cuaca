...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h2><i class="fa-solid fa-plus me-2"></i> Tambah Peran</h2>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="peran_nama" class="form-control @error('peran_nama') is-invalid @enderror" value="{{ old('peran_nama') }}" placeholder="Masukkan nama peran">
                    @error('peran_nama')
