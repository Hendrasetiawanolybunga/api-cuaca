            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="pestisida_tanggal_pakai" value="{{ old('pestisida_tanggal_pakai') }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pestisida_jenis" value="{{ old('pestisida_jenis') }}"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pestisida_dosis_pakai" value="{{ old('pestisida_dosis_pakai') }}"
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        @if (Auth::user()->pengguna_peran === 'petani')
                            {{-- Filter musim tanam milik kebun pengguna ini --}}
                            @php
                            ...
                            @endif
                        @else
                            {{-- Admin / penyuluh bisa pilih semua --}}
                            <select name="mt_id" class="form-select @error('mt_id') is-invalid @enderror" required>
