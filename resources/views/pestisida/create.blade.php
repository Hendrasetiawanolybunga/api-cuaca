...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <h2><i class="fa-solid fa-plus me-2"></i> Tambah Pestisida</h2>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="pestisida_tanggal_pakai" value="{{ old('pestisida_tanggal_pakai') }}" class="form-control @error('pestisida_tanggal_pakai') is-invalid @enderror" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="pestisida_jenis" value="{{ old('pestisida_jenis') }}" class="form-control @error('pestisida_jenis') is-invalid @enderror" placeholder="Masukkan jenis pestisida" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="pestisida_dosis_pakai" value="{{ old('pestisida_dosis_pakai') }}" class="form-control @error('pestisida_dosis_pakai') is-invalid @enderror" placeholder="Masukkan dosis pakai" required>
                ...
                <div class="input-group">
                    ...
                    <select name="mt_id" class="form-select @error('mt_id') is-invalid @enderror" required>
                        ...
                        @foreach($musimTanam as $mt)
                            <option value="{{ $mt->mt_id }}" {{ old('mt_id') == $mt->mt_id ? 'selected' : '' }}>{{ $mt->mt_komoditas }} - {{ $mt->kebun->kebun_nama }}</option>
                        @endforeach
                    </select>
                    @error('mt_id')
                        <div class="invalid-feedback">{{ $message }}</div>
