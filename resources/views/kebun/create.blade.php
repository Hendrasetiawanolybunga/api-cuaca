        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kebun_nama" class="form-control @error('kebun_nama') is-invalid @enderror" value="{{ old('kebun_nama') }}" placeholder="Masukkan nama kebun" required>
                    @error('kebun_nama')
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kebun_lokasi" class="form-control @error('kebun_lokasi') is-invalid @enderror" value="{{ old('kebun_lokasi') }}" placeholder="Masukkan lokasi kebun" required>
                    @error('kebun_lokasi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="input-group">
                    ...
                    <select name="pengguna_id" class="form-select @error('pengguna_id') is-invalid @enderror" required>
                        ...
                        @foreach($pengguna as $p)
                            <option value="{{ $p->pengguna_id }}" {{ old('pengguna_id') == $p->pengguna_id ? 'selected' : '' }}>{{ $p->pengguna_nama }}</option>
                        @endforeach
                    </select>
                    @error('pengguna_id')
                        <div class="invalid-feedback">{{ $message }}</div>
