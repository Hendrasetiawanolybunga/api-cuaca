            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kebun_nama" value="{{ old('kebun_nama', $kebun->kebun_nama) }}"
                            class="form-control @error('kebun_nama') is-invalid @enderror" placeholder="Masukkan nama kebun"
                            required>
                        @error('kebun_nama')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kebun_lokasi" value="{{ old('kebun_lokasi', $kebun->kebun_lokasi) }}"
                            class="form-control @error('kebun_lokasi') is-invalid @enderror"
                            placeholder="Masukkan lokasi kebun" required>
                        @error('kebun_lokasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        @if (Auth::user()->pengguna_peran === 'petani')
                            {{-- Untuk petani: input readonly + hidden field --}}
