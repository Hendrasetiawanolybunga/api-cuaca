                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="mt_tanggal_tanam"
                            class="form-control @error('mt_tanggal_tanam') is-invalid @enderror"
                            value="{{ old('mt_tanggal_tanam') }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="mt_tanggal_panen"
                            class="form-control @error('mt_tanggal_panen') is-invalid @enderror"
                            value="{{ old('mt_tanggal_panen') }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="mt_komoditas"
                            ...
                            value="{{ old('mt_komoditas') }}" placeholder="Masukkan jenis komoditas" required>
                        @error('mt_komoditas')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="input-group">
                        ...
                        @if (Auth::user()->pengguna_peran === 'petani')
                            {{-- Untuk petani: hanya tampilkan kebun miliknya --}}
                            @php
                                ...
                                <select name="kebun_id" class="form-select @error('kebun_id') is-invalid @enderror"
                                    ...
                                    @foreach ($kebunPetani as $k)
                                        <option value="{{ $k->kebun_id }}"
                                            {{ old('kebun_id') == $k->kebun_id ? 'selected' : '' }}>
                                            {{ $k->kebun_nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            @endif
                        @else
                            {{-- Untuk admin/penyuluh: tampilkan semua kebun --}}
