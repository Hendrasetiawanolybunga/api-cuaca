        ...
        <form action="{{ route('pupuk.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="pupuk_tanggal_pakai" value="{{ old('pupuk_tanggal_pakai') }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="pupuk_jenis" value="{{ old('pupuk_jenis') }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" step="0.01" name="pupuk_jumlah_pakai" value="{{ old('pupuk_jumlah_pakai') }}"
